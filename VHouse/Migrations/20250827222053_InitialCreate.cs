        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InventoryId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CustomerId = table.Column<int>(type: "INTEGER", nullable: false),
                    IsGeneralInventory = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInventoryEntry = table.Column<bool>(type: "INTEGER", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "TEXT", nullable: false),
                    Discount = table.Column<decimal>(type: "TEXT", nullable: false),
                    ShippingCost = table.Column<decimal>(type: "TEXT", nullable: false),
                    DeliveryDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    SelectedStore = table.Column<string>(type: "TEXT", nullable: true),
                    CustomerId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    PriceCost = table.Column<decimal>(type: "TEXT", nullable: false),
                    PriceRetail = table.Column<decimal>(type: "TEXT", nullable: false),
                    PriceSuggested = table.Column<decimal>(type: "TEXT", nullable: false),
                    PricePublic = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DistributionCenterId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TenantId = table.Column<int>(type: "INTEGER", nullable: false),
                    CenterCode = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Address = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DistributionCenters_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "INTEGER", nullable: false),
                    DistributionCenterId = table.Column<int>(type: "INTEGER", nullable: false),
                    RouteCode = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryRoutes_DistributionCenters_DistributionCenterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DistributionCenterId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShrinkageRecordId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProductId = table.Column<int>(type: "INTEGER", nullable: false),
                    WarehouseId = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    CostImpact = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShrinkageRecords", x => x.ShrinkageRecordId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShrinkageRecords_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "WarehouseId",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Delivery_Location",
                table: "Deliveries",
                columns: new[] { "Latitude", "Longitude" });

            migrationBuilder.CreateIndex(
                name: "IX_Delivery_Route_Status",
                table: "Deliveries",
                columns: new[] { "DeliveryRouteId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Delivery_ScheduledDate",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryRoute_Center_Active",
                table: "DeliveryRoutes",
                columns: new[] { "DistributionCenterId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryRoute_IsActive",
                table: "DeliveryRoutes",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryRoutes_TenantId_RouteCode",
                table: "DeliveryRoutes",
                columns: new[] { "TenantId", "RouteCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DistributionCenter_IsActive",
                table: "DistributionCenters",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_DistributionCenter_Location",
                table: "DistributionCenters",
                columns: new[] { "Latitude", "Longitude" });

            migrationBuilder.CreateIndex(
                name: "IX_DistributionCenters_TenantId_CenterCode",
                table: "DistributionCenters",
                columns: new[] { "TenantId", "CenterCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Inventory_Customer",
                table: "Inventories",
                column: "CustomerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InventoryItem_Expiration",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrder_Supplier_Status",
                table: "PurchaseOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShrinkageRecord_DiscoveryDate",
                table: "ShrinkageRecords",
                column: "DiscoveryDate");

            migrationBuilder.CreateIndex(
                name: "IX_ShrinkageRecord_IsApproved",
                table: "ShrinkageRecords",
                column: "IsApproved");

            migrationBuilder.CreateIndex(
                name: "IX_ShrinkageRecord_Reason",
                table: "ShrinkageRecords",
                column: "Reason");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShrinkageRecords_WarehouseId",
                table: "ShrinkageRecords",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseInventory_Quantity",
                table: "WarehouseInventories",
